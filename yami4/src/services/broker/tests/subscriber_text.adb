   ...
   procedure Call
     ...
     procedure Process
       (Content : in out YAMI.Parameters.Parameters_Collection) is
        ...
        Text : constant String := Content.Get_String ("value");

     begin
        Ada.Text_IO.Put_Line ("got message: " & Text);
     end Process;
...
begin
   if Ada.Command_Line.Argument_Count /= 2 then
      ...
      Ada.Text_IO.Put_Line ("    list of tags for subscribing");
   ...
   begin
      ...
      Subscriber_Agent.Send_One_Way
        (Broker_Address, List_Of_Tags, "subscribe", Params);
