...
package body YAMI.Core.Agents is
   ...
   --  TODO: this additional overloaded procedure is a workaround
   --  for the GNAT bug, to be removed when fixed
   ...
   Cpp_Sizeof_Agent : constant Interfaces.C.size_t;
   pragma Import (C, Cpp_Sizeof_Agent, "sizeof_agent");
...
begin
   ...
   pragma Assert (Ada_Sizeof_Agent >= Cpp_Sizeof_Agent);
