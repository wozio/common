...
procedure Core_Agent_Test is
   ...
   package body Test_3 is
      ...
      begin
         YAMI.Parameters.Init_Parameters (Message_Header);
         YAMI.Parameters.Init_Parameters (Message_Body);
      ...
      begin
         YAMI.Core.Agents.Init_Agent
           (Server_Agent, My_Incoming_Message_Handler'Unchecked_Access);
         ...
         begin
            YAMI.Core.Agents.Init_Agent (Client_Agent, null);

            YAMI.Parameters.Init_Parameters (Short_Header);
            YAMI.Parameters.Init_Parameters (Short_Body);
            YAMI.Parameters.Init_Parameters (Long_Header);
            YAMI.Parameters.Init_Parameters (Long_Body);
